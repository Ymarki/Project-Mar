...
namespace _Script
{
    ...
    {
        /*
            Основной смысл класса "ArcherModel" - составить описание объекта "Archer".

            1) Его дальность стрельбы.
            2) Его скорострельность.
            3) Направление в которое он будет стрелять.
        */
